                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Ngày Đăng Ký</b> <a class="float-right">{{ $data->created_at->format('Y-m-d') }}</a>
                                </li>
                            </ul>

                            <a href="#"
                                class="btn btn-block {{ $data->status == 1 ? 'btn-info' : 'btn-warning' }}"><b>
                                    {{ $data->status == 1 ? 'Đang Hoạt Động' : 'Chưa Kích Hoạt' }}</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                            ...
                            <p class="text-muted">
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <button id="updateStatus" class="btn {{ $data->status == 0 ? 'btn-warning' : 'btn-info' }}">
                                            {{ $data->status == 0 ? 'Kích Hoạt' : 'Đã Kích Hoạt' }}
                                        </button>
                                    </div>
                                    <div class="col-sm-6">
                                        <a type="button" href="/admin/approves" class="btn btn-default f-right">
                                            Hủy
                                        </a>
                                    </div>
                                </div>
